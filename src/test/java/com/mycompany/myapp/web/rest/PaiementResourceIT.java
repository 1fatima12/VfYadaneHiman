...
class PaiementResourceIT {
    ...
    private static final ModePaiement DEFAULT_TYPE = ModePaiement.CHEQUE;
    private static final ModePaiement UPDATED_TYPE = ModePaiement.TPE;
    ...
    public static Paiement createEntity(EntityManager em) {
        Paiement paiement = new Paiement().type(DEFAULT_TYPE).avance(DEFAULT_AVANCE).etat(DEFAULT_ETAT);
        return paiement;
    }
    ...
    public static Paiement createUpdatedEntity(EntityManager em) {
        Paiement paiement = new Paiement().type(UPDATED_TYPE).avance(UPDATED_AVANCE).etat(UPDATED_ETAT);
        return paiement;
    }
    ...
    void createPaiement() throws Exception {
        ...
        assertThat(testPaiement.getAvance()).isEqualTo(DEFAULT_AVANCE);
    ...
    void putNewPaiement() throws Exception {
        ...
        updatedPaiement.type(UPDATED_TYPE).avance(UPDATED_AVANCE).etat(UPDATED_ETAT);
        ...
        assertThat(testPaiement.getAvance()).isEqualTo(UPDATED_AVANCE);
    ...
    void partialUpdatePaiementWithPatch() throws Exception {
        ...
        partialUpdatedPaiement.avance(UPDATED_AVANCE).etat(UPDATED_ETAT);
    ...
    void fullUpdatePaiementWithPatch() throws Exception {
        ...
        partialUpdatedPaiement.type(UPDATED_TYPE).avance(UPDATED_AVANCE).etat(UPDATED_ETAT);
