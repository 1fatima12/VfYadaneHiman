...
export class CommandeFournisseurComponent implements OnInit {
  ...
  trackId(_index: number, item: ICommandeFournisseur): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICommandeFournisseur[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
