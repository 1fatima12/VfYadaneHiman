...
export class StockComponent implements OnInit {
  ...
  trackId(_index: number, item: IStock): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IStock[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
