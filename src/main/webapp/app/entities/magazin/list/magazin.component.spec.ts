...
describe('Magazin Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'magazin', component: MagazinComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.magazins?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
