...
describe('BonCommande Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'bon-commande', component: BonCommandeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bonCommandes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
